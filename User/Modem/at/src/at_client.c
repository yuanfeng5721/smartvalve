...
volatile sRingbuff        g_ring_buff;
volatile static at_client sg_at_client = {0};
volatile static uint32_t  sg_flags     = 0;
volatile static ThreadParams thread_params = {0};
...
#ifdef AT_DEBUG
    at_print_raw_cmd("at_client_send", buf, size);
#endif
