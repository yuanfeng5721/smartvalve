...
typedef enum { eNO_SERVICE = 0, eGSM = 1,  eLTE_CATM1= 2, eLTE_NBIOT = 3} eModemNetMode;

typedef enum { eONLINE = 0, eOFFLINE = 1,  eFACTORY_TEST= 2, eRESET = 3, eLOW_POWER = 4} eOperationMode;

typedef struct ue_info {
	eModemNetMode system_mode;
